...
<body>
  <div class="header">
      ...
      <a href="logOut.php"><button class = "LogOutButton" style="float: right">Log Out</button><a/>
  </div>
  ...
  <div class="navbar">
	  ...
	  <a href="favourites.php"><button class = "navBarButtons" style="float: right;">My Fav Recipes</button></a>
